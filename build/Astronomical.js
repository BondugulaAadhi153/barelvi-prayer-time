...
const Astronomical = {
    ...
    solarEquationOfTheCenter(julianCentury, meanAnomaly) {
        ...
        const Mrad = (0, MathUtils_1.degreesToRadians)(meanAnomaly);
    ...
    apparentSolarLongitude(julianCentury, meanLongitude) {
        ...
        const Lambda = longitude - 0.00569 - 0.00478 * Math.sin((0, MathUtils_1.degreesToRadians)(Omega));
    ...
    nutationInLongitude(julianCentury, solarLongitude, lunarLongitude, ascendingNode) {
        ...
        /* Equation from Astronomical Algorithms page 144 */
        const term1 = (-17.2 / 3600) * Math.sin((0, MathUtils_1.degreesToRadians)(Omega));
        const term2 = (1.32 / 3600) * Math.sin(2 * (0, MathUtils_1.degreesToRadians)(L0));
        const term3 = (0.23 / 3600) * Math.sin(2 * (0, MathUtils_1.degreesToRadians)(Lp));
        const term4 = (0.21 / 3600) * Math.sin(2 * (0, MathUtils_1.degreesToRadians)(Omega));
        return term1 - term2 - term3 + term4;
    },
    nutationInObliquity(julianCentury, solarLongitude, lunarLongitude, ascendingNode) {
        ...
        const Omega = ascendingNode;
        /* Equation from Astronomical Algorithms page 144 */
        const term1 = (9.2 / 3600) * Math.cos((0, MathUtils_1.degreesToRadians)(Omega));
        const term2 = (0.57 / 3600) * Math.cos(2 * (0, MathUtils_1.degreesToRadians)(L0));
        const term3 = (0.1 / 3600) * Math.cos(2 * (0, MathUtils_1.degreesToRadians)(Lp));
        const term4 = (0.09 / 3600) * Math.cos(2 * (0, MathUtils_1.degreesToRadians)(Omega));
        return term1 + term2 + term3 - term4;
    },
    altitudeOfCelestialBody(observerLatitude, declination, localHourAngle) {
        ...
        const term1 = Math.sin((0, MathUtils_1.degreesToRadians)(Phi)) * Math.sin((0, MathUtils_1.degreesToRadians)(delta));
        const term2 = Math.cos((0, MathUtils_1.degreesToRadians)(Phi)) *
    ...
    correctedTransit(approximateTransit, longitude, siderealTime, rightAscension, previousRightAscension, nextRightAscension) {
        ...
        /* Equation from page Astronomical Algorithms 102 */
        const Lw = L * -1;
        const Theta = (0, MathUtils_1.unwindAngle)(Theta0 + 360.985647 * m0);
        const a = (0, MathUtils_1.unwindAngle)(Astronomical.interpolateAngles(a2, a1, a3, m0));
        const H = (0, MathUtils_1.quadrantShiftAngle)(Theta - Lw - a);
        const dm = H / -360;
        return (m0 + dm) * 24;
    },
    correctedHourAngle(approximateTransit, angle, coordinates, afterTransit, siderealTime, rightAscension, previousRightAscension, nextRightAscension, declination, previousDeclination, nextDeclination) {
        ...
        const term1 = Math.sin((0, MathUtils_1.degreesToRadians)(h0)) -
        ...
        const H0 = (0, MathUtils_1.radiansToDegrees)(Math.acos(term1 / term2));
        const m = afterTransit ? m0 + H0 / 360 : m0 - H0 / 360;
        const Theta = (0, MathUtils_1.unwindAngle)(Theta0 + 360.985647 * m);
        const a = (0, MathUtils_1.unwindAngle)(Astronomical.interpolateAngles(a2, a1, a3, m));
    ...
    interpolateAngles(y2, y1, y3, n) {
        /* Equation from Astronomical Algorithms page 24 */
        const a = (0, MathUtils_1.unwindAngle)(y2 - y1);
        const b = (0, MathUtils_1.unwindAngle)(y3 - y2);
        const c = b - a;
        return y2 + (n / 2) * (a + b + n * c);
    },
